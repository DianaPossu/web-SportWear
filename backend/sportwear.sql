...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-11-2024 a las 07:05:05
...
(1, '501678901', 'Ricardo Gómez', 'Avenida 6N, Cali', '555890123', 'ricardogomez@email.com', 150),
(2, '606789012', 'Ana Gómez', 'Bulevar del rio, Cali', '987654321', 'ana.gomez@email.com', 150),
(3, '2134569870', 'Carlos Martínez', 'Calle Principal 789, Pereira', '321234890', 'carlos.martinez@email.com', 657);
...
INSERT INTO `compras` (`id compras`, `fecha`, `fo_proveedor`, `productos`, `subtotal`, `total`, `fo_usuario`) VALUES
(1, '2024-10-10', 1, 'Camisetas deportivas, Pantalones de entrenamiento', 93, 115, 3),
(2, '2024-10-11', 2, 'Zapatillas de running, Botas de fútbol', 186, 230, 1),
(3, '2024-10-12', 3, 'Muñequeras deportivas, Gorra deportiva', 28, 35, 2);
...
INSERT INTO `municipios` (`id_ciudad`, `municipio`, `estado`, `departamento_id`) VALUES
(1, 'Abriaquí', 1, 5),
(2, 'Acacías', 1, 50),
(3, 'Acandí', 1, 27),
(4, 'Acevedo', 1, 41),
...
INSERT INTO `producto` (`id_producto`, `codigo`, `nombre`, `fo_categoria`, `precio_compra`, `precio_venta`, `stock`, `fo_proveedor`) VALUES
(1, 'A001', 'Camiseta deportiva', 1, 45, 55, 100, 1),
(2, 'B002', 'Pantalón de entrenamiento', 1, 70, 85, 150, 1),
(3, 'C001', 'Zapatillas de running', 2, 80, 150, 200, 2),
(4, 'D002', 'Botas de fútbol', 2, 150, 295, 80, 2),
(5, 'E001', 'Muñequeras deportivas', 3, 10, 20, 300, 3),
(6, 'F002', 'Gorra deportiva', 3, 25, 50, 120, 3),
(10, 'F008', 'li', 3, 25, 50, 120, 3);
...
(1, '1234056789', 'Proveedor 1', 'Calle principal 123, Cali', '111-123456', 'contacto@proveedor1.com', 150),
(2, '9876540321', 'Proveedor 2', 'Avenida Principal 456, Palmira', '123-987654', 'contacto@proveedor2.com', 639),
(3, '12233445', 'Proveedor 3', 'Calle Comercio 789, Pereira', '455-112233', 'contacto@proveedor3.com', 657);
...
(1, '10123467', 'María Fernández', 'Avenida Libertador 5678, Palmira', '555-321654', 'mariafernandez@email.com', 'admin', 'admin2024'),
(2, '33456789', 'Luis Martínez', 'Calle Real 2345, Pereira', '555-654321', 'luismartinez@email.com', 'vendedor', 'vendedor2024'),
(3, '2045678901', 'Lucía González', 'Calle Quinta, Cali', '555-789012', 'luciagonzalez@email.com', 'vendedor', 'vendedor123'),
(4, '501678901', 'Ricardo Gómez', 'Avenida 6N, Cali', '555890123', 'ricardogomez@email.com', 'cliente', 'cliente456'),
(5, '606789012', 'Ana Gómez', 'Bulevar del rio, Cali', '987654321', 'ana.gomez@email.com', 'cliente', 'cliente876'),
(6, '707890123', 'Javier Díaz', 'Avenida 2020, Palmira', '555-123789', 'javierdiaz@email.com', 'admin', 'admin789'),
(7, '2134569870', 'Carlos Martínez', 'Calle Principal 789, Pereira', '321234890', 'carlos.martinez@email.com', 'cliente', 'cliente123');
...
(1, '2024-11-08', 2, 'Camiseta deportiva, Pantalón de entrenamiento', 140, 166.6, 3),
(2, '2024-11-08', 1, 'Zapatillas de running, Muñequeras deportivas', 170, 202.3, 3),
(3, '2024-11-09', 3, 'Botas de fútbol, Gorra deportiva', 345, 410.55, 2);
...
--
ALTER TABLE `compras`
  MODIFY `id compras` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `municipios`
  MODIFY `id_ciudad` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1101;
...
--
ALTER TABLE `cliente`
  ADD CONSTRAINT `cliente_ibfk_1` FOREIGN KEY (`fo_ciudad`) REFERENCES `municipios` (`id_ciudad`) ON DELETE NO ACTION ON UPDATE CASCADE;
...
--
ALTER TABLE `municipios`
  ADD CONSTRAINT `municipios_ibfk_1` FOREIGN KEY (`departamento_id`) REFERENCES `departamentos` (`id_departamento`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Filtros para la tabla `producto`
--
ALTER TABLE `producto`
  ADD CONSTRAINT `producto_ibfk_1` FOREIGN KEY (`fo_proveedor`) REFERENCES `proveedor` (`id_prov`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Filtros para la tabla `proveedor`
--
ALTER TABLE `proveedor`
  ADD CONSTRAINT `proveedor_ibfk_1` FOREIGN KEY (`fo_ciudad`) REFERENCES `municipios` (`id_ciudad`) ON DELETE NO ACTION ON UPDATE CASCADE;
